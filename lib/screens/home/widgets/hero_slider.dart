...
class HeroSlider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Performance: Using Selector instead of Consumer to only rebuild when heroSlides changes.
    // This prevents unnecessary rebuilds when other parts of HomeProvider (like episode lists) update.
    return Selector<HomeProvider, List<Show>>(
      selector: (_, provider) => provider.heroSlides,
