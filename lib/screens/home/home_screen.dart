...
class HomeScreen extends StatelessWidget {
        ...
        return RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              // Use SliverGrid for lazy loading of episodes
              ..._buildNewEpisodesSlivers(context, allRecentEpisodes, provider),
              SliverToBoxAdapter(
  ...
  List<Widget> _buildNewEpisodesSlivers(
      BuildContext context, List<Episode> episodes, HomeProvider provider) {
    if (episodes.isEmpty) {
      return [
        SliverToBoxAdapter(
          child: Container(
